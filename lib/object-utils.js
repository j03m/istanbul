...
(function (isNode) {
    ...
    function mergeSummaryObjectsPCT() {
        var ret = blankSummary(),
            args = Array.prototype.slice.call(arguments),
            keys = ['lines', 'statements', 'branches', 'functions'],
            increment = function (obj) {
                if (obj) {
                    keys.forEach(function (key) {
                        if (ret[key].pct==='Unknown'){
                            ret[key].pct =0;
                        }
                        ret[key].pct += obj[key].pct;
        ...
        keys.forEach(function (key) {
            ret[key].pct = (ret[key].pct/args.length).toFixed(2);
    ...
    function summarizeCoverage(coverage) {
        ...
        return mergeSummaryObjectsPCT.apply(null, fileSummary);
    }
    ...
    var exportables = {
        ...
        mergeSummaryObjectsPCT:mergeSummaryObjectsPCT,
